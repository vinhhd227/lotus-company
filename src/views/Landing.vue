  ...
  <div>
    <div class="position-relative">
      ...
      <section class="section-shaped my-0">
        <div class="shape shape-default shape-skew bg-custom">
          <span></span>
          <span></span>
          <span></span>
          <span></span>
            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3 text-white font-weight-bold">
                  "Uy tính, chuyên nghiệp, tận tâm"
                </h1>
                <p class="lead text-white">
                  Công ty cổ phần vật tư thiết bị Lotus
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row row-grid align-items-center">
          <div class="col-md-6 order-md-2">
            <img src="img/about.jpg" class="img-fluid floating" />
          </div>
              ...
              <div class="col-md-6 mb-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <div>
                    ...
                    <badge type="primary" rounded>điện tử</badge>
                    <badge type="primary" rounded>do lường</badge>
                  </div>
                  <base-button
                    tag="a"
                    href="#"
              ...
              <div class="col-md-6 mb-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <div>
                    ...
                    <badge type="warning" rounded>tối ưu</badge>
                  </div>
                  <base-button
                    tag="a"
                    href="#"
              ...
              <div class="col-md-6 mb-4">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <div>
                    ...
                    <badge type="danger" rounded>logistic</badge>
                  </div>
                  <base-button
                    tag="a"
                    href="#"
    ...
    <section class="section section-shaped my-0 overflow-hidden">
      <div class="shape shape-style-3 bg-gradient-default shape-skew"></div>
      <div class="container pt-md pb-300">
        ...
        <div class="row row-grid mt-1">
          <div class="col-lg-4">
            <h5 class="text-white mt-3">Liên hệ</h5>
            <ul>
              <li class="list-group-item border-0 bg-trans">
                CÔNG TY CỔ PHẦN VẬT TƯ THIÊT BỊ LOTUS
              </li>
              <li class="list-group-item border-0 bg-trans">
                <a href="tel:0903455202">0903455202</a>
              </li>
              <li class="list-group-item border-0 bg-trans">website</li>
              <li class="list-group-item border-0 bg-trans">
                <a href="mailto:contact@lotusco.com.vn">
                  contact@lotusco.com.vn
                </a>
              </li>
            </ul>
...
.bg-custom {
  background-image: url(../../public/img/header-bg.jpg) !important;
}
</style>
